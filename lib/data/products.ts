...
const BASE_PRODUCTS: Product[] = [
  { id:1,  slug:'halo-solitaire-ring',   name:'Halo Solitaire Ring',      category:'fine',   type:'ring',     stone:'cvd-colourless', cut:'round',   metals:['18k-rose','18k-white','platinum'], priceFrom:2800,  carat:'1.2 ct',      featured:true,  isNew:false, shortMeta:'Lab-Grown · 1.2ct · 18K Rose',    gemColor:'#D4A840', gemStyle:'round'   },
  { id:2,  slug:'teardrop-pendant',      name:'Teardrop Pendant',         category:'fine',   type:'pendant',  stone:'cvd-colourless', cut:'pear',    metals:['18k-yellow','18k-white'],        priceFrom:1600,  carat:'0.9 ct',      featured:true,  isNew:true,  shortMeta:'Lab-Grown · 0.9ct · 18K Yellow',  gemColor:'#D4A840', gemStyle:'pear'    },
  { id:3,  slug:'tennis-bracelet-4ct',   name:'Tennis Bracelet',          category:'fine',   type:'bracelet', stone:'cvd-colourless', cut:'round',   metals:['14k','18k-white','platinum'],    priceFrom:4200,  carat:'4.0 ct',      featured:true,  isNew:false, shortMeta:'Lab-Grown · 4ct · 14K',           gemColor:'#D4A840', gemStyle:'row'     },
  ...
  { id:5,  slug:'pear-drop-necklace',    name:'Pear Drop Necklace',       category:'fine',   type:'necklace', stone:'cvd-colourless', cut:'pear',    metals:['18k-white','18k-yellow'],        priceFrom:2100,  carat:'1.1 ct',      featured:true,  isNew:false, shortMeta:'Lab-Grown · 1.1ct · 18K',         gemColor:'#D4A840', gemStyle:'pear'    },
  { id:6,  slug:'eternity-band',         name:'Diamond Eternity Band',    category:'fine',   type:'ring',     stone:'cvd-colourless', cut:'round',   metals:['18k-white','18k-yellow','platinum'],priceFrom:3200,carat:'1.5 ct',     featured:true,  isNew:false, shortMeta:'Lab-Grown · Full Set · 18K',      gemColor:'#D4A840', gemStyle:'eternity'},
