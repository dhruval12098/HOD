  ...
  return (
    <section style={{ padding: "110px 52px", maxWidth: "1400px", margin: "0 auto" }} className="founders-section">
      ...
      <div style={{ textAlign: "center", marginBottom: "56px" }}>
        ...
        <h2 className={`${cinzelFont.variable} font-primary-display`} style={{ fontSize: "clamp(40px, 5.5vw, 72px)", fontWeight: 300, letterSpacing: ".02em", color: "#0A1628", lineHeight: 1.05 }}>
