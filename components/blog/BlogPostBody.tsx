...
export default function BlogPostBody({ title, subtitle, body, contentBlocks = [] }: BlogPostBodyProps) {
  return (
    <>
      <h1
        className={`${cinzelFont.variable} font-primary-display mb-6 w-full text-[clamp(36px,5vw,58px)] font-light leading-[1.08] tracking-[0.01em] text-[#0A1628] [&_em]:font-[inherit] [&_em]:italic`}
      ...
      <div
        className={`${cinzelFont.variable} blog-article-content
          [&_p]:font-[var(--font-manrope)] [&_p]:text-[15.5px] [&_p]:leading-[1.95] [&_p]:text-[#333A44] [&_p]:mb-6 [&_p]:font-normal
          [&_:is(h1,h2,h3,h4,h5,h6)]:font-[var(--font-family-primary)] [&_:is(h1,h2,h3,h4,h5,h6)]:font-normal [&_:is(h1,h2,h3,h4,h5,h6)]:tracking-[0.01em] [&_:is(h1,h2,h3,h4,h5,h6)]:text-[#0A1628] [&_:is(h1,h2,h3,h4,h5,h6)]:mt-11 [&_:is(h1,h2,h3,h4,h5,h6)]:mb-4 [&_:is(h1,h2,h3,h4,h5,h6)]:leading-[1.1]
          ...
          [&_blockquote]:before:content-['“'] [&_blockquote]:before:absolute [&_blockquote]:before:left-4 [&_blockquote]:before:top-3 [&_blockquote]:before:font-[var(--font-family-primary)] [&_blockquote]:before:text-[48px] [&_blockquote]:before:leading-none [&_blockquote]:before:text-[#A7864C]
          [&_blockquote_p]:font-[var(--font-family-primary)] [&_blockquote_p]:text-[22px] [&_blockquote_p]:italic [&_blockquote_p]:font-normal [&_blockquote_p]:text-[#172236] [&_blockquote_p]:m-0 [&_blockquote_p]:leading-[1.55]
      ...
      {contentBlocks.length > 0 ? (
        <div className={`${cinzelFont.variable} blog-article-content mt-10 space-y-10`}>
          {contentBlocks.map((block) => {
            ...
            if (block.type === 'heading' && block.heading) {
              return (
                <h3
                  key={block.id}
                  className={`${cinzelFont.variable} font-primary-display text-[33px] font-semibold leading-[1.1] tracking-[0.01em] text-[#0A1628] [&_em]:font-[inherit] [&_em]:italic`}
